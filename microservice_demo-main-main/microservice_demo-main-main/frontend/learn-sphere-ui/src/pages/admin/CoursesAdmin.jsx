...
import {
  getAllCoursesApi as getAllCourses,
  createCourseApi as createCourse,
  updateCourseApi as updateCourse,
  deleteCourseApi as deleteCourse,
} from "../../api/courseApi";
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="flex bg-slate-900/50 border-b border-[var(--border)]">
              <button
                ...
                className={`px-8 py-4 text-[10px] font-black uppercase tracking-widest transition-none ${activeTab === "details"
              ...
              <button
                ...
                className={`px-8 py-4 text-[10px] font-black uppercase tracking-widest transition-none ${activeTab === "assessment"
                    ? "text-[#2563eb] border-b-2 border-[#2563eb] bg-blue-500/5"
                    : "text-slate-500"
                  }`}
              >
              ...
              <button
                ...
                className={`px-8 py-4 text-[10px] font-black uppercase tracking-widest transition-none ${activeTab === "quizzes"
                    ? "text-[#2563eb] border-b-2 border-[#2563eb] bg-blue-500/5"
                    : "text-slate-500"
                  }`}
              >
