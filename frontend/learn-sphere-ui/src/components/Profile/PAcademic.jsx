...
export const PAcademic = () => {
  const [rollNumber, setRollNumber] = useState(() => localStorage.getItem("studentRollNumber") || "");
  const [course, setCourse] = useState(() => localStorage.getItem("studentCourse") || "");
  const [year, setYear] = useState(() => localStorage.getItem("studentYear") || "");
